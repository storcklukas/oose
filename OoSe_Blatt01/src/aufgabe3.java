...
public class aufgabe3 {
	public static void main(String[] args) {
		...
		sc.close(); // selber hinzugefügt wg. "warning Ressource leak"

		System.out.println(b = false); // Stelle 2 für Erklärung (siehe oben)

		System.out.println(b == true ? "b ist wahr." : "b ist falsch."); // für f)
	}
}
